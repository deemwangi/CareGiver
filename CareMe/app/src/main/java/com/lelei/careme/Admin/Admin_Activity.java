...
import com.lelei.careme.Helpers.Admin_All_Doctor_Adapter;
import com.lelei.careme.Helpers.Doctors_Session_Mangement;
import com.lelei.careme.Models.Doctors_Profile;
...
public class Admin_Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference nm= FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Doctors_Data");
