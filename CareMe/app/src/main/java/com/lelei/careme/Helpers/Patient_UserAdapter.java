...
import com.lelei.careme.CareSeeker.Patient_MessageActivity;
...
public class Patient_UserAdapter extends RecyclerView.Adapter<Patient_UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull Patient_UserAdapter.ViewHolder holder, int position) {
        ...
        String url = "";
        DatabaseReference reference = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Doctors_Data").child(email).child("doc_pic");
