...
import com.lelei.careme.Helpers.Patient_UserAdapter;
...
public class Patient_Chat_Display extends AppCompatActivity {
    ...
    private void status(String status){
        reference = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Patient_Details").child(phone);
