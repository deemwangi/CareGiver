package com.lelei.careme.CareGiver;
...
import com.lelei.careme.AskRole;
import com.lelei.careme.Helpers.Appointments_Adapter;
import com.lelei.careme.Helpers.Doctors_Session_Mangement;
import com.lelei.careme.Models.Appointment_notif;
import com.lelei.careme.Models.Retrieve_Appointments;
...
public class Doctors extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference nm= FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Doctors_Chosen_Slots");
        patient= FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Patient_Chosen_Slots");
        ...
        reference = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Doctors_Appointments");
