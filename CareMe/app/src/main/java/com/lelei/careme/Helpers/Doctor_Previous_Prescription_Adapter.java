...
import com.lelei.careme.CareGiver.Doctors_Show_Previous_Prescription_Doctors;
...
public class Doctor_Previous_Prescription_Adapter extends RecyclerView.Adapter<Doctor_Previous_Prescription_Adapter.ViewHolder> {
    ...
    public Doctor_Previous_Prescription_Adapter(ArrayList<Get_Previous_Prescription_Details> get_prescription_details, Context mContext) {
