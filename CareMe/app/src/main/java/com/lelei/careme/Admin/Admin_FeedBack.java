...
import com.lelei.careme.Helpers.Admin_FeedBack_Adapter;
...
public class Admin_FeedBack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Doctors_Feedback");
                ...
                reference.child(email).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(snapshot.exists()) {
                            ...
                            admin_feedBack_adapter = new Admin_FeedBack_Adapter(email_val, name_val, dates, time, phone_num);
                            recyclerView.setAdapter(admin_feedBack_adapter);
                            Toast.makeText(Admin_FeedBack.this, "Care Giver has no Current Feedbacks", Toast.LENGTH_SHORT).show();
