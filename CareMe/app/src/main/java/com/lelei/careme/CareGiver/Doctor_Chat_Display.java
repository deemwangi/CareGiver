...
import com.lelei.careme.Helpers.Doctor_UserAdapter;
...
public class Doctor_Chat_Display extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        reference_patient = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Patient_Details");
