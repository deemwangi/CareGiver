...
import com.lelei.careme.Models.PrescriptionDetails;
...
public class Doctors_Show_Previous_Prescription_Doctors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctors_show_previous_prescription_doctors);
        ...
        doctor = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Users");
        prescription_doctor = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Prescription_By_Doctor");
