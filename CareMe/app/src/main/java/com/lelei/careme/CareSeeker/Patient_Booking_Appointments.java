...
public class Patient_Booking_Appointments extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_booking_appointments);
                ...
                reference_booking.child(email).child(date_val).child(slot_val).child(check).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()) {
                            ...
                            Toast.makeText(Patient_Booking_Appointments.this, "The Care Giver is not available! Select other slot!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
