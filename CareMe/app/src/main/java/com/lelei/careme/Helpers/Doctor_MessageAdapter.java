...
public class Doctor_MessageAdapter extends RecyclerView.Adapter<Doctor_MessageAdapter.ViewHolder> {
    ...
    public Doctor_MessageAdapter(Context mContext, List<Chat> mChat, String imageurl, String emailID) {
